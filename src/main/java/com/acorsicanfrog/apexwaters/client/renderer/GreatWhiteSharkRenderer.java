...
public class GreatWhiteSharkRenderer extends MobRenderer<GreatWhiteSharkEntity, GreatWhiteSharkModel> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(ApexWaters.MODID, "textures/entity/great_white_shark.png");
    private static final ResourceLocation EPIC_TEXTURE = ResourceLocation.fromNamespaceAndPath(ApexWaters.MODID, "textures/entity/great_white_shark_epic.png");
